...
<!-- ------search bar -->
	...
	<!-- ------search bar finish -->
						...
						<form  action="SupplierReport.jsp"  method="post">  
...
<input type="submit"  value="generate report" >
						...
						<div class="col-md-4">
						<input type="text" id="myInput1" onkeyup="myFunction()" placeholder="Search supplier ID.." title="Type in a name">
				  ...
				  <br> </br>
							...
							<table border="1" cellpadding="12" id="supp"
