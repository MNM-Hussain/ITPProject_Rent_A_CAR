...
<title>Update Maintenance Details</title>
...
<body>
	...
	<h5 class="card-title mb-0 text-center">Maintenance Manager</h5></div>
	<div class="card-body text-center"><br>
	<img src="images/avatar7.png" alt="Marie Salter" class="img-fluid rounded-circle mb-2" width="128" height="128">
	<h4 class="card-title mb-0"></h4><br><div>
	...
	<div class="card" style="height: 523px; border-radius: .2rem; border: px solid transparent;">
	<div class="card-header">
	...
	<td>	<form action="UpdateForm.jsp" method="post">
				<input type="hidden" name="vechID"  class="btn btn-primary"value="<%=repairandmaintenance.getVehicleID()%>">
				<input type="hidden" name="ENDDATE"  class="btn btn-primary"value="<%=repairandmaintenance.getEnd_Date()%>">
					<button>Update</button>
		</form></td>
	
	
	<td><form method="POST" action="DeleteMaintenanceServlet?VehicleID=<%=repairandmaintenance.getVehicleID()%>">
