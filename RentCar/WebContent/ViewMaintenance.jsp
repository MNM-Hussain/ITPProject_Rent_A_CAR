	...
	<li class='sub-menu'><a href='Statistics.jsp'>Statistics</a></li>
			...
			<div class="col-md-8 col-xl-9">
				<div class="card" style="height: 523px;">
					<div class="card-header">
						...
						<form method="post" action="search_maintanance.jsp"
							...
							<input type="text" name="date1"	placeholder="search End Date" style=" color: black;" required> 
					...
					<br>
								...
								<form  action="Maintenance_Report.jsp"  method="post">  

									<input type="text" name="year" placeholder="Enter the Year.." id="year">
									...
									<input type="submit"  value="Get report" >
										...
										<br>
						<form  action="Maintenance_Cost_Report.jsp"  method="post">  

								<input type="text" name="month" placeholder="Enter the month.." id="month">
				...
				<br>
					...
					<div style="height: 560px; overflow-x: auto;">
